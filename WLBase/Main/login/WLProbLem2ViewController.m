...
@interface WLProbLem2ViewController ()<UITextFieldDelegate>

@end

@implementation WLProbLem2ViewController
...
- (void)clickNext
{
    WLProblem3ViewController *vc =[[WLProblem3ViewController alloc] init];
